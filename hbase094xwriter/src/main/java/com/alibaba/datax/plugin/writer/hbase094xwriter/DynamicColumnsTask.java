...
/**
 * Created by miaozhongyin on 12/4/16.
 */
public class DynamicColumnsTask extends HbaseAbstractTask{
    private static final Logger LOG = LoggerFactory.getLogger(DynamicColumnsTask.class);
    public DynamicColumnsTask(Configuration configuration) {
        super(configuration);
    }

    /**
     * miao
     * 定义put方法，如何将记录写入到hbase
     * @param record
     * @return
     */
    @Override
